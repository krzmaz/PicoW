...
function(getEspIdf)
    ...
    if (NOT esp-idf_POPULATED)
        ...
        if (NOT IDF_TOOLS_PATH_FILES)
            ...
            if (WIN32)
                message(STATUS "Install dependencies for Windows")
                execute_process(COMMAND "install.bat" $ENV{IDF_TARGET} WORKING_DIRECTORY ${esp-idf_SOURCE_DIR})
            else ()
                message(STATUS "Install dependencies for MacOS/Linux")
